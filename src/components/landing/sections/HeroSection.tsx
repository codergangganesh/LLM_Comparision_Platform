      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <button
              onClick={handleClick}
              className="group relative px-8 py-4 rounded-2xl text-lg font-bold transition-all duration-300 flex items-center space-x-3 overflow-hidden backdrop-blur-sm transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent focus:ring-blue-500"
            >
              {/* Gradient background */}
              ...
              <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${
                darkMode
                  ? 'from-blue-400 via-purple-400 to-pink-400'
                  : 'from-blue-400 via-purple-400 to-pink-400'
              } opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-0.5`}>
              ...
              <div className="relative z-10 flex items-center space-x-3">
                ...
                <span className={`font-bold text-lg transition-all duration-300 ${
                  ...
                  {user ? 'Start Comparing Now' : 'Get Started'}
                </span>
              ...
              <div className="absolute inset-0 rounded-2xl opacity-0 group-active:opacity-100 transition-opacity duration-100">
            ...
            <button
              ...
              className={`flex items-center space-x-4 px-6 py-3 rounded-full backdrop-blur-xl transition-all duration-300 transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent ${
                darkMode
                  ? 'bg-gray-800/60 border border-gray-700/50 hover:bg-gray-800/80 focus:ring-gray-600'
                  : 'bg-white/70 border border-slate-200/50 hover:bg-white/90 focus:ring-slate-300'
              }`}
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div 
                    key={i} 
                    className={`w-10 h-10 rounded-full border-2 backdrop-blur-sm flex items-center justify-center transition-all duration-300 group-hover:scale-110 ${
                      darkMode 
