...
interface EditConversationPopupProps {
  isOpen: boolean
  onClose: () => void
...
export default function EditConversationPopup({ 
  isOpen, 
  onClose, 
  onSave,
  conversation,
  darkMode = false
}: EditConversationPopupProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (title.trim()) {
      onSave(conversation.id, title.trim(), description.trim())
      setTitle('')
      setDescription('')
    }
  }
